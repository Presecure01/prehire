...
const AddNewCard = () => {
  ...
  const handleSave = (e) => {
    ...
    setSaving(false);
    navigate('/recruiter/add-balance');
  };
...
const styles = {
  ...
  formShell: { marginTop: 24, background: '#fff', border: '1px solid #E5E7EB', borderRadius: 12, padding: 20, width: 'min(680px, 92%)', marginLeft: 'auto', marginRight: 'auto', boxShadow: '0 1px 2px rgba(0,0,0,0.03)' },
  cardHeaderRow: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, marginBottom: 16 },
  cardHeaderTitle: { fontSize: 18, fontWeight: 700, color: '#111827' },
  networks: { display: 'flex', alignItems: 'center', gap: 6 },
  badge: { fontSize: 12, padding: '2px 6px', borderRadius: 6, border: '1px solid rgba(0,0,0,0.05)' },
  grid2col: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 },
  fieldCol: { display: 'flex', flexDirection: 'column', marginBottom: 10 },
  label: { fontSize: 13, color: '#6B7280', marginBottom: 6 },
  input: { padding: '10px 12px', border: '1px solid #D1D5DB', borderRadius: 8, width: '100%', background: '#F9FAFB', fontSize: 14, boxSizing: 'border-box' },
  select: { padding: '10px 12px', border: '1px solid #D1D5DB', borderRadius: 8, width: '100%', background: '#F9FAFB', fontSize: 14, boxSizing: 'border-box' },
  primaryBtn: { width: '100%', background: '#3B82F6', color: '#fff', border: 'none', borderRadius: 8, padding: '12px 16px', cursor: 'pointer', fontWeight: 600, marginTop: 6 },
  secondaryBtn: { width: '100%', background: '#fff', color: '#111827', border: '1px solid #9CA3AF', borderRadius: 8, padding: '12px 16px', cursor: 'pointer', fontWeight: 600, marginTop: 10 },
  disclaimer: { color: '#6B7280', fontSize: 12, marginTop: 12 },
  accountCard: { marginTop: 24, background: '#F9FAFB', border: '1px solid #E5E7EB', borderRadius: 12, padding: 16, width: 'min(760px, 92%)', marginLeft: 'auto', marginRight: 'auto' }
};
